...
function instruction() {
    console.log("Цей скрипт розв'язує прямокутний трикутник.");
    console.log("Як користуватись:");
    console.log("Відкрийте консоль і введіть triangle(firstValue, \"typeOfFirstValue\", secondValue, \"typeOfSecondValue\"), де:");
    console.log("1. \"firstValue\" може бути позитивним значенням для сторони, гіпотенузи, прилеглого кута (до сторони, в градусах)," +
    " протилежного кута (до сторони, в градусах) і, нарешті, кута (якщо вводиться або буде введена гіпотенуза), в градусах;");
    console.log("2. \"typeOfFirstValue\" - рядок, який може бути \"leg\" (сторона), \"hypotenuse\" (гіпотенуза), \"adjacent angle\" (прилеглий кут)" +
    ", \"opposite angle\" (протилежний кут), \"angle\" (кут);");
    console.log("3. \"secondValue\" і \"typeOfSecondValue\" мають той самий зміст, що й \"firstValue\" і \"typeOfFirstValue\".");
    }
